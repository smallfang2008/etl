    ...
    <form id ="N_Form" class="form-horizontal" action="${pageContext.request.contextPath}/etl/node/addNode.do" method="post">
      ...
      <div class="row">
        <div class="control-group span13">
          ...
          <div class="controls">
            <input name="nodeCode" type="text" class="control-text" data-rules="{required:true,maxlength:50}" style="width: 200px;">
          </div>
        </div>
        <div class="control-group span13">
      ...
      <div class="row">
        <div class="control-group span13">
          ...
          <div class="controls" id="getClusterTask">
          	<input type="hidden" id="getClusterTaskHide" value="Y" name="isGetClusterTask">
          </div>
        </div>
      </div>
