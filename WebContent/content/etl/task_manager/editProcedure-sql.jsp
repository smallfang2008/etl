...
<html>
 ...
 <body>
  ...
  <div class="container">
  	<h3>步骤修改</h3>
  	<hr>
	<form id ="N_Form" class="form-horizontal" action="${pageContext.request.contextPath}/etl/procedure/editStepSql.do" method="post">
		<div class="row">
		...
		<div class="row">
			...
			<div class="control-group span14">
				...
				<div class="controls">
					<select data-rules="{required:true}" id="sjlx" name="dbName" class="input-normal" style="width:auto;">
					</select>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="control-group span15">
			  	...
			  	<div class="controls control-row4">
			    	<textarea id="sqls" name="sqls" class="input-large" type="text"></textarea>
			  	</div>
			</div>
		</div>
		<div class="row">
	...
	var jldata = [];
  	...
  	function oraclelist(value){
  	 ...
  	 $(document).ready(function(){
  		...
  		$.ajax({
  			type:'post',
  			url:'${pageContext.request.contextPath}/etl/procedure/getSqlStep.do?stepId=${step.stepId}',
  			dataType:'json',
  			success:function(data){
  				oraclelist(data["dbName"]);
  				$("#sqls").val(data["sqls"]);
  			}
  		});
