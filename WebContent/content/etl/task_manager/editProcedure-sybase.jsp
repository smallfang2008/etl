...
<html>
 ...
 <body>
  ...
  <div class="container">
  	<h3>步骤修改</h3>
  	<hr>
	<form id ="N_Form" class="form-horizontal" action="${pageContext.request.contextPath}/etl/procedure/editStepSybase.do" method="post">
		<div class="row">
		...
		<div class="row">
			...
			<div class="control-group span14">
				...
				<div class="controls">
					<select data-rules="{required:true}" id="sjlx" name="serverName" class="input-normal" style="width:auto;">
					</select>
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="control-group span8">
				...
				<div class="controls">
					<input name="encoding" id="encoding" type="text" class="input-normal control-text">
				</div>
			</div>
		</div>
		<div class="row">
  ...
  <script type="text/javascript">
	var jldata = [];
  	...
  	function oraclelist(value){
  		$.ajax({
  			type:'post',
  			url:'${pageContext.request.contextPath}/etl/procedure/getSybaseList.do',
  			dataType:'json',
  	 ...
  	 $(document).ready(function(){
  		...
  		$.ajax({
  			type:'post',
  			url:'${pageContext.request.contextPath}/etl/procedure/getSybaseStep.do?stepId=${step.stepId}',
  			dataType:'json',
  			success:function(data){
