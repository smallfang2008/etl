...
<html>
 ...
 <body>
  ...
  <div class="container">
  	<h3>步骤新增</h3>
  	<hr>
	<form id ="N_Form" class="form-horizontal" action="${pageContext.request.contextPath}/etl/procedure/addStepShell.do" method="post">
		<div class="row">
		...
		<div class="row">
			<div class="control-group span16">
			  	...
			  	<div class="controls control-row6">
			    	<textarea name="shellCommands" class="input-large"></textarea>
			  	</div>
			</div>
		</div>
		<div class="row">
