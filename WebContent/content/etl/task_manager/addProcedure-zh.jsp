...
<html>
 ...
 <body>
  ...
  <div class="container">
  	<h3>步骤新增</h3>
  	<hr>
	<form id ="N_Form" class="form-horizontal" action="${pageContext.request.contextPath}/etl/procedure/addStepzh.do" method="post">
		<div class="row">
		...
		<div class="row">
			...
			<div class="control-group span8">
				...
				<div class="controls">
					<input name="superClass" type="text" data-rules="{required:true}" class="input-normal control-text" />
				</div>
			</div>
		</div>
		<div class="row">
			<div class="control-group span16">
				...
				<div class="controls">
					<input name="charset" data-tip='{"text":"不填时默认为GBK"}' type="text" class="input-normal control-text" />
				</div>
			</div>
		</div>
		<div class="row">
