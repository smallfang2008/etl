...
<html>
 ...
 <body>
  ...
  <div class="container">
  	<h3>步骤修改</h3>
  	<hr>
	<form id ="N_Form" class="form-horizontal" action="${pageContext.request.contextPath}/etl/procedure/editStepShell.do" method="post">
		<div class="row">
		...
		<div class="row">
			...
			<div class="control-group span14">
				...
				<div class="controls">
					<select data-rules="{required:true}" id="sjlx" name="resourceName" class="input-normal" style="width:auto;">
					</select>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="control-group span15">
			  	<label class="control-label">shell脚本：</label>
			  	<div class="controls control-row6">
			    	<textarea id="shellCommands" name="shellCommands" class="input-large" type="text"></textarea>
			  	</div>
			</div>
		</div>
		<div class="row">
	...
	var jldata = [];
  	...
  	function resourceList(value){
  	 ...
  	 $(document).ready(function(){
  		...
  		$.ajax({
  			type:'post',
  			url:'${pageContext.request.contextPath}/etl/procedure/getShellStep.do?stepId=${step.stepId}',
  			dataType:'json',
  			success:function(data){
  				resourceList(data["resourceName"]);
  				$("#shellCommands").val(data["shellCommands"]);
  			}
  		});
