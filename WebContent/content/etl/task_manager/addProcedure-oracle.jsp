...
<html>
 ...
 <body>
  ...
  <div class="container">
  	<h3>步骤新增</h3>
  	<hr>
	<form id ="N_Form" class="form-horizontal" action="${pageContext.request.contextPath}/etl/procedure/addStepOracle.do" method="post">
		<div class="row">
		...
		<div class="row">
			<div class="control-group span15">
			  	...
			  	<div class="controls control-row4">
			    	<textarea name="prepareSql" class="input-large" type="text"></textarea>
			  	</div>
			</div>
		</div>
		<div class="row">
			<div class="control-group span15">
			  	...
			  	<div class="controls control-row4">
			    	<textarea name="postSql" class="input-large" type="text"></textarea>
			  	</div>
			</div>
		</div>
		<div class="row">
			<div class="control-group span15">
			  	...
			  	<div class="controls control-row4">
			    	<textarea name="columns"  data-tip='{"text":"逗号分隔"}' class="input-large" type="text"></textarea>
			  	</div>
			</div>
		</div>
		<div class="row">
			<div class="control-group span8">
				...
				<div class="controls">
					<input name="tableName" type="text" class="input-normal control-text">
				</div>
			</div>
			<div class="control-group span8">
				<label class="control-label">字段分隔符：</label>
				<div class="controls">
					<input name="dataSplit" type="text" data-tip='{"text":"不填时默认转换分隔符#_#"}' class="input-normal control-text">
				</div>
			</div>
		</div>
		<div class="row">
			<div class="control-group span16">
				...
				<div class="controls">
					<input name="encoding" type="text" class="input-normal control-text">&nbsp;ZHS16GBK/AL32UTF8...
				</div>
			</div>
		</div>
		<div class="row">
  	 ...
  	 $(document).ready(function(){
  		...
  		$.ajax({
  			...
  			success:function(data){
  				...
  				sjlx.html("");
  				for(var i = 0; i < data.length; i++){
  					sjlx.append('<option value="'+data[i].NAME+'">'+data[i].NAME+'</option>');
  				}
  			}
  		});
