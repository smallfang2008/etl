...
<html>
 ...
 <body>
  ...
  <div class="container">
  	<h3>步骤新增</h3>
  	<hr>
	<form id ="N_Form" class="form-horizontal" action="${pageContext.request.contextPath}/etl/procedure/addStepOracleExp.do" method="post">
		<div class="row">
		...
		<div class="row">
			<div class="control-group span20">
			  	...
			  	<div class="controls control-row6">
			    	...
			    	<textarea name="sqls" class="input-large"></textarea>注：字段之间请拼接分隔符
			  	</div>
			</div>
		</div>
		<div class="row">
			<div class="control-group span16">
				...
				<div class="controls">
					<input name="filename" type="text" class="input-normal control-text">
		...
		<div class="row">
			<div class="control-group span16">
				...
				<div class="controls">
					<input name="fileTimeOffset" type="text" value="0" class="input-normal control-text">&nbsp;（天）
				</div>
			</div>
		</div>
		<div class="row">
