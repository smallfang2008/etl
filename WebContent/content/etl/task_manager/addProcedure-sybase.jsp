...
<html>
 ...
 <body>
  ...
  <div class="container">
  	<h3>步骤新增</h3>
  	<hr>
	<form id ="N_Form" class="form-horizontal" action="${pageContext.request.contextPath}/etl/procedure/addStepSybase.do" method="post">
		<div class="row">
		...
		<div class="row">
			<div class="control-group span8">
				...
				<div class="controls">
					<select data-rules="{required:true}" id="yxwz" name="type" class="input-normal">
					</select>
		...
		<div class="row">
			...
			<div class="control-group span8">
				...
				<div class="controls">
					<input name="encoding" type="text" class="input-normal control-text">
				</div>
			</div>
		</div>
		<div class="row">
