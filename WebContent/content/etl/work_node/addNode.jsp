...
<html>
 ...
 <body>
  ...
  <div class="container">
  	<h3>节点新建</h3>
  	<hr>
    <form id ="N_Form" class="form-horizontal" action="${pageContext.request.contextPath}/etl/node/addNode.do" method="post">
      <!--    -->
      <div class="row">
        <div class="control-group span13">
          <label class="control-label"><s>*</s>节点编码：</label>
          <div class="controls">
            <input name="nodeCode" type="text" class="control-text" data-rules="{required:true,maxlength:50}" style="width: 200px;" onblur="checkExistNodeCode(this);">
          </div>
        ...
        <div class="control-group span13">
          ...
          <div class="controls">
            <input name="ipAddress" type="text"  class="control-text" data-rules="{required:true,maxlength:15}" style="width: 200px;">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="control-group span13">
          ...
          <div class="controls">
            <input name="serverName" type="text"  class="control-text" data-rules="{required:true,maxlength:130}" style="width: 200px;">
          </div>
        </div>
        <div class="control-group span13">
          <label class="control-label"><s>*</s>日志目录：</label>
          <div class="controls">
            <input name="logPath" type="text" class="control-text" data-rules="{required:true,maxlength:130}" style="width: 200px;">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="control-group span13">
          ...
          <div class="controls" id="serverCluserName">
          	<input type="hidden" id="serverCluserNameHide"  name="serverCluster.serverClusterId" data-rules="{required:true}">
          </div>
        </div>
        <div class="control-group span13">
          <label class="control-label"><s>*</s>最大任务数：</label>
          <div class="controls">
            <input name="maxTasks" type="text"  class="control-text" data-rules="{required:true,number:true,min:0,max:100}" style="width: 200px;">
          </div>
        </div>
      </div>
      <div class="row">
        <div class="control-group span13">
          ...
          <div class="controls" id="getClusterTask">
          	<input type="hidden" id="getClusterTaskHide" value="1" name="isGetClusterTask">
          </div>
        </div>
      </div>
  ...
  <script type="text/javascript">
  	...
  	var N_Form = new BUI.Form.HForm({
        ...
        callback : function(data){
        	if(data=="1"){
        		BUI.Message.Alert("节点新建成功!",function(){
					location.href="${pageContext.request.contextPath}/content/etl/work_node/nodeList.jsp";
				},"success");
        		//history.back();
        	}else{
            	...
            	if (2 == data)
                	...
                	tip = "服务器集群为空！";
        		BUI.Message.Alert("节点新建失败!<br>失败信息："+tip,function(){},"error");
        	}
