 ...
 *
 */
@Service("HuaweiRelayDataOutNewFtpConvert")
public class HuaweiRelayDataOutNewFtpConvert implements IConvertExecuter{
...
//	}
	...
	public String doConvert(String data, String filePathName) throws Exception {
		...
		return dataArray[0] + ConvertUtil.SPIT_SIGN 
				+filterQuota(dataArray[1])+ ConvertUtil.SPIT_SIGN 
				+ filterQuota(dataArray[2]) + ConvertUtil.SPIT_SIGN
				+ 0 + ConvertUtil.SPIT_SIGN 
				+ dataArray[4-1]+ ConvertUtil.SPIT_SIGN 
				+ dataArray[5-1] + ConvertUtil.SPIT_SIGN
				+ dataArray[7-1] + ConvertUtil.SPIT_SIGN 
				+ dataArray[10-1]+ ConvertUtil.SPIT_SIGN 
				+ dataArray[11-1] + ConvertUtil.SPIT_SIGN
				+ dataArray[44-1] + ConvertUtil.SPIT_SIGN 
				+ dataArray[45-1]+ ConvertUtil.SPIT_SIGN 
				+ dataArray[46-1] + ConvertUtil.SPIT_SIGN
				+ dataArray[47-1] + ConvertUtil.SPIT_SIGN
				+ dataArray[39-1] + ConvertUtil.SPIT_SIGN 
				+ dataArray[40-1]+ ConvertUtil.SPIT_SIGN+"OUT"+ ConvertUtil.SPIT_SIGN+ dataArray[38-1]+ ConvertUtil.SPIT_SIGN+ "\n";
	}
