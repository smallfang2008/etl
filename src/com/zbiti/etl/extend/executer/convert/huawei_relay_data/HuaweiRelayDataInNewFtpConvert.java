 ...
 *
 */
@Service("HuaweiRelayDataInNewFtpConvert")
public class HuaweiRelayDataInNewFtpConvert implements IConvertExecuter{
...
16	AST	平均占用时常
	 */
//	@Override
//	public String doConvert1(String data, String filePathName) throws Exception {
...
//	}
	...
	public String doConvert(String data, String filePathName) throws Exception {
		...
		return dataArray[0] + ConvertUtil.SPIT_SIGN 
				+filterQuota(dataArray[1])+ ConvertUtil.SPIT_SIGN 
				+ filterQuota(dataArray[2]) + ConvertUtil.SPIT_SIGN
				+ 0 + ConvertUtil.SPIT_SIGN //中继群号给个0
				+ dataArray[4-1]+ ConvertUtil.SPIT_SIGN 
				+ dataArray[5-1] + ConvertUtil.SPIT_SIGN
				+ dataArray[6-1] + ConvertUtil.SPIT_SIGN 
//				+ dataArray[6] + ConvertUtil.SPIT_SIGN //占用率   占用率不要了。
				+ dataArray[9-1]+ ConvertUtil.SPIT_SIGN 
				+ dataArray[10-1] + ConvertUtil.SPIT_SIGN
				+ dataArray[33-1] + ConvertUtil.SPIT_SIGN 
				+ dataArray[34-1]+ ConvertUtil.SPIT_SIGN 
				+ dataArray[25-1] + ConvertUtil.SPIT_SIGN
				+ dataArray[26-1] + ConvertUtil.SPIT_SIGN
				+ dataArray[27-1] + ConvertUtil.SPIT_SIGN 
				+ dataArray[28-1]+ ConvertUtil.SPIT_SIGN+"IN"+ ConvertUtil.SPIT_SIGN+ "\n";
	}
...
//			File f=new File("D:/huawei_delay_data/in.txt");
			File f=new File("D:/huawei_delay_data/TKGINC_SOFTXV3_V300R010C05_1545.csv");
...
//				System.out.print(new HuaweiRelayDataInConvert().doConvert1(temp, ""));
